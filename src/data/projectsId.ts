...
export const PROJECTS_DATA_ID: Project[] = [
  {
    ...
    category: 'backend',
    flag: 'Install & Cloud',
    badge: 'Backend & Data Engineering',
  ...
  },
  {
    ...
    title: 'Dashboard Pemantauan Udara - Membangun Sistem Prediksi Kualitas Udara Berbasis AI/LLM',
    subtitle: 'Dashboard pemantauan sensor AQMS real-time dengan prediksi berbasis AI/LLM dan Sistem Peringatan Dini (EWS)',
    category: 'backend',
    flag: 'Lead Project &  Backend',
    badge: 'Pipeline AI Prediction & Data Vizualization',
    status: 'Pemeliharaan & Peningkatan Sistem',
  ...
  {
    id: 'trusur-erp',
    title: 'Trusur ERP (Enterprise Resource Planning) - Pemeliharaan & Pengembangan Fitur',
  ...
  {
    id: 'efs-aqms-edge',
    title: 'EFS - AQMS Edge System (Pengambilan & Pemasukan Data Sensor)',
  ...
  },
  {
    ...
    category: 'website',
    flag: 'Website',
    badge: ' Full-stack Web , Cloud SaaS & POS',
