...
export const PROJECTS_DATA_EN: Project[] = [
  ...
  },
  {
    ...
    title: 'Dashboard Air Quality Monitoring - Built a Machine Learning Prediction Pipeline',
  ...
  {
    id: 'trusur-erp',
    title: 'Trusur ERP (Enterprise Resource Planning) - Application Maintenance & Feature Development',
  ...
  {
    id: 'efs-aqms-edge',
    title: 'EFS - AQMS Edge System ( Ingestion & Acquisition )',
